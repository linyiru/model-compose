...
- [Component Configuration](/model-compose/ko/reference/compose/component.md) - Define components that use system-managed infrastructure
- [Gateway Configuration](/model-compose/ko/reference/compose/gateway.md) - Expose services through tunnels
- [Workflow Configuration](/model-compose/ko/reference/compose/workflow.md) - Orchestrate jobs using components
