...
See [model.md](/model-compose/ko/reference/compose/components/model.md) for the full quantization schema.
...
7. **Pre-format with `datasets`**: Use the [datasets.md](/model-compose/ko/reference/compose/components/datasets.md) component's `map` method to produce a clean `text_column`
...
- [datasets.md](/model-compose/ko/reference/compose/components/datasets.md) — Prepare and format training data
- [model.md](/model-compose/ko/reference/compose/components/model.md) — Inference for the resulting fine-tuned model
- [model-tokenizer.md](/model-compose/ko/reference/compose/components/model-tokenizer.md) — Standalone tokenization for input validation
