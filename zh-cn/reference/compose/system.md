...
- [Component Configuration](/model-compose/zh-cn/reference/compose/component.md) - Define components that use system-managed infrastructure
- [Gateway Configuration](/model-compose/zh-cn/reference/compose/gateway.md) - Expose services through tunnels
- [Workflow Configuration](/model-compose/zh-cn/reference/compose/workflow.md) - Orchestrate jobs using components
