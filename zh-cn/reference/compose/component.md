...
|------|-------------|---------------|
| `agent` | Autonomous AI agent with tool use | [agent.md](/model-compose/zh-cn/reference/compose/components/agent.md) |
| `http-client` | HTTP client for making API requests | [http-client.md](/model-compose/zh-cn/reference/compose/components/http-client.md) |
| `http-server` | HTTP server for hosting services | [http-server.md](/model-compose/zh-cn/reference/compose/components/http-server.md) |
| `mcp-server` | MCP server for protocol support | [mcp-server.md](/model-compose/zh-cn/reference/compose/components/mcp-server.md) |
| `mcp-client` | MCP (Model Context Protocol) client | [mcp-client.md](/model-compose/zh-cn/reference/compose/components/mcp-client.md) |
| `model` | AI model inference (local/remote) | [model.md](/model-compose/zh-cn/reference/compose/components/model.md) |
| `model-memory` | Session-based conversation memory | [model-memory.md](/model-compose/zh-cn/reference/compose/components/model-memory.md) |
| `model-tokenizer` | Model tokenization (encode, decode, count) | [model-tokenizer.md](/model-compose/zh-cn/reference/compose/components/model-tokenizer.md) |
| `model-trainer` | Model fine-tuning (SFT, classification, LoRA) | [model-trainer.md](/model-compose/zh-cn/reference/compose/components/model-trainer.md) |
| `datasets` | Dataset loading and transformation | [datasets.md](/model-compose/zh-cn/reference/compose/components/datasets.md) |
| `vector-store` | Vector database operations | [vector-store.md](/model-compose/zh-cn/reference/compose/components/vector-store.md) |
| `graph-store` | Graph database operations | [graph-store.md](/model-compose/zh-cn/reference/compose/components/graph-store.md) |
| `search-engine` | Full-text search engine (SQLite FTS5) | [search-engine.md](/model-compose/zh-cn/reference/compose/components/search-engine.md) |
| `key-value-store` | Key-value data storage | [key-value-store.md](/model-compose/zh-cn/reference/compose/components/key-value-store.md) |
| `file-store` | File/object storage (local, AWS S3, GCP Storage, Azure Blob) | [file-store.md](/model-compose/zh-cn/reference/compose/components/file-store.md) |
| `workflow` | Sub-workflow execution | [workflow.md](/model-compose/zh-cn/reference/compose/components/workflow.md) |
| `shell` | Shell command execution | [shell.md](/model-compose/zh-cn/reference/compose/components/shell.md) |
| `text-splitter` | Text processing and splitting | [text-splitter.md](/model-compose/zh-cn/reference/compose/components/text-splitter.md) |
| `image-processor` | Image transformation and processing | [image-processor.md](/model-compose/zh-cn/reference/compose/components/image-processor.md) |
| `video-scene-detector` | Video scene change detection | [video-scene-detector.md](/model-compose/zh-cn/reference/compose/components/video-scene-detector.md) |
...
| `web-scraper` | Web page scraping with CSS/XPath | [web-scraper.md](/model-compose/zh-cn/reference/compose/components/web-scraper.md) |
| `web-browser` | Browser automation via Chrome DevTools Protocol | [web-browser.md](/model-compose/zh-cn/reference/compose/components/web-browser.md) |
...
- See [workflow.md](/model-compose/zh-cn/reference/compose/workflow.md) for information on using components in workflows
