...
### Core Configuration
- [Controller](/model-compose/reference/compose/controller.md) - HTTP and MCP server configuration
- [Workflow](/model-compose/reference/compose/workflow.md) - Job orchestration and execution logic
- [Component](/model-compose/reference/compose/component.md) - Reusable service definitions and common properties

### Infrastructure & Services
- [System](/model-compose/reference/compose/system.md) - Infrastructure service management (Docker Compose)
- [Listener](/model-compose/reference/compose/listener.md) - Webhook and callback handling
- [Gateway](/model-compose/reference/compose/gateway.md) - Tunneling and external access
- [Tracer](/model-compose/reference/compose/tracer.md) - Tracing configuration and observability
- [Logger](/model-compose/reference/compose/logger.md) - Logging configuration and output management

### Reference
- [Language Codes](/model-compose/reference/compose/language-codes.md) - Standardized language codes for multilingual components

### Components
- [HTTP Client](/model-compose/reference/compose/components/http-client.md) - External API integration
- [HTTP Server](/model-compose/reference/compose/components/http-server.md) - Web server hosting
- [MCP Client](/model-compose/reference/compose/components/mcp-client.md) - Model Context Protocol client
- [MCP Server](/model-compose/reference/compose/components/mcp-server.md) - Model Context Protocol server
- [Model](/model-compose/reference/compose/components/model.md) - AI/ML model inference
- [Vector Store](/model-compose/reference/compose/components/vector-store.md) - Vector database operations
- [Key-Value Store](/model-compose/reference/compose/components/key-value-store.md) - Key-value data storage
- [Shell](/model-compose/reference/compose/components/shell.md) - System command execution
- [Text Splitter](/model-compose/reference/compose/components/text-splitter.md) - Document processing
- [Workflow](/model-compose/reference/compose/components/workflow.md) - Nested workflow execution
...
1. **Choose Your Controller**: Start with [Controller](/model-compose/reference/compose/controller.md) to set up your server
2. **Define Your Workflow**: Use [Workflow](/model-compose/reference/compose/workflow.md) to orchestrate your logic
3. **Add Components**: Select from [Component](/model-compose/reference/compose/component.md) types for your functionality
4. **Configure Infrastructure**: Add [Listener](/model-compose/reference/compose/listener.md), [Gateway](/model-compose/reference/compose/gateway.md), [Tracer](/model-compose/reference/compose/tracer.md), or [Logger](/model-compose/reference/compose/logger.md) as needed
